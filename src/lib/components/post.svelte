<script lang="ts">
	import { display_time, GeneratePostId, post_url } from '$lib';
	...
	import XLg from 'svelte-bootstrap-svg-icons/XLg.svelte';
	...
	onMount(() => {
		autosaveTimer = setInterval(() => {
			...
			dbd.draft_cache.put({ url: window.location.pathname, markdown: markdown });
	...
	<div class="flex-grow justify-center">
		<Card class="max-w-3xl">
			...
			<div class="flex justify-end">
				<h6 class="mb-2 text-md font-bold tracking-tight text-gray-900 dark:text-white">
